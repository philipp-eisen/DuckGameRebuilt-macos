...
namespace DuckGame
{
    public class Unlockables
    {
        ...
        public static List<Unlockable> lockedItems => _unlocks.Where(x => !x.CheckCondition() && x.allowHints && x.description != null && x.description != "").ToList();

        public static void Initialize()
        {
            _unlocks.Add(new UnlockableHats(false, "hatpack1", new List<Team>()
      {
        Teams.GetTeam("BAWB"),
        Teams.GetTeam("Frank"),
        Teams.GetTeam("Meeee")
      }, () => Unlocks.IsUnlocked("HATTY1"), "Hat Pack 1", "Check out these nifty cool hats."));
            _unlocks.Add(new UnlockableHats(false, "hatpack2", new List<Team>()
      {
        Teams.GetTeam("Pulpy"),
        Teams.GetTeam("Joey"),
        Teams.GetTeam("Cowboys")
            ...
            bool futz = false;
            _unlocks.Add(new UnlockableAchievement(false, "gamerduck", () => Global.data.timesSpawned > (futz ? 0 : 99), "Duck Gamer", "Spawn 100 times.", "play100"));
            ...
            _unlocks.Add(new UnlockableAchievement(false, "ritual", () => Global.data.timesSpawned > (futz ? 1 : 999), "Ritual", "Spawn 1000 times.", "play1000"));
            _unlocks.Add(new UnlockableHat("skully", Teams.GetTeam("SKULLY"), () => Global.data.kills > (futz ? 3 : 999), "SKULLY", "Kill 1000 Ducks", "kill1000"));
            _unlocks.Add(new UnlockableAchievement(false, "endurance", () => Global.data.longestMatchPlayed > (futz ? 5 : 49), "Endurance", "Play through a 50 point match", "endurance"));
            _unlocks.Add(new UnlockableAchievement(false, "outgoing", () => Global.data.onlineWins > (futz ? 0 : 9), "Outgoing", "Win 10 online matches", "online10"));
            ...
            _unlocks.Add(new UnlockableHat("ballz", Teams.GetTeam("BALLZ"), () => Global.data.ducksCrushed > (futz ? 0 : 49), "BALLZ", "Crush 50 Ducks", "crate"));
            _unlocks.Add(new UnlockableHat("hearts", Teams.GetTeam("Hearts"), () => Global.data.matchesPlayed > (futz ? 0 : 49), "<3", "Finish 50 whole matches.", "finish50"));
            ...
            _unlocks.Add(new UnlockableHat("eggpal", Teams.GetTeam("eggpal"), () => Global.data.winsAsSwack > (futz ? 0 : 4), "EGGPAL", "Win 5 rounds as SWACK"));
            _unlocks.Add(new UnlockableHat("brad", Teams.GetTeam("brad"), () => Global.data.disarms > (futz ? 0 : 99), "BRAD DUNGEON", "Disarm 100 ducks."));
            _unlocks.Add(new UnlockableHat("brick", Teams.GetTeam("BRICK"), () => Global.data.laserBulletsFired > (futz ? 0 : 149), "BRICK", "Fire 150 laser bullets."));
            ...
            _unlocks.Add(new UnlockableHats("toeboynearlsHats", new List<Team>()
      {
        ...
        Teams.GetTeam("bigearls")
            ...
            _unlocks.Add(new UnlockableHats(false, "swimhats", new List<Team>()
      {
        ...
        Teams.GetTeam("wahhs")
            ...
            if (Teams.GetTeam(str1) != null)
                _unlocks.Add(new UnlockableHat(false, str1.ToLowerInvariant(), Teams.GetTeam(str1), () => Global.boughtHats.Contains("CYCLOPS"), str1, Teams.GetTeam(str1).description));
            string str2 = "MOTHERS";
            if (Teams.GetTeam(str2) != null)
                _unlocks.Add(new UnlockableHat(false, str2.ToLowerInvariant(), Teams.GetTeam(str2), () => Global.boughtHats.Contains("MOTHERS"), str2, Teams.GetTeam(str2).description));
            string str3 = "BIG ROBO";
            if (Teams.GetTeam(str3) != null)
                _unlocks.Add(new UnlockableHat(false, str3.ToLowerInvariant(), Teams.GetTeam(str3), () => Global.boughtHats.Contains("BIG ROBO"), str3, Teams.GetTeam(str3).description));
            string str4 = "TINCAN";
            if (Teams.GetTeam(str4) != null)
                _unlocks.Add(new UnlockableHat(false, str4.ToLowerInvariant(), Teams.GetTeam(str4), () => Global.boughtHats.Contains("TINCAN"), str4, Teams.GetTeam(str4).description));
            string str5 = "WELDERS";
            if (Teams.GetTeam(str5) != null)
                _unlocks.Add(new UnlockableHat(false, str5.ToLowerInvariant(), Teams.GetTeam(str5), () => Global.boughtHats.Contains("WELDERS"), str5, Teams.GetTeam(str5).description));
            string str6 = "PONYCAP";
            if (Teams.GetTeam(str6) != null)
                _unlocks.Add(new UnlockableHat(false, str6.ToLowerInvariant(), Teams.GetTeam(str6), () => Global.boughtHats.Contains("PONYCAP"), str6, Teams.GetTeam(str6).description));
            string str7 = "TRICORNE";
            if (Teams.GetTeam(str7) != null)
                _unlocks.Add(new UnlockableHat(false, str7.ToLowerInvariant(), Teams.GetTeam(str7), () => Global.boughtHats.Contains("TRICORNE"), str7, Teams.GetTeam(str7).description));
            string str8 = "TWINTAIL";
            if (Teams.GetTeam(str8) != null)
                _unlocks.Add(new UnlockableHat(false, str8.ToLowerInvariant(), Teams.GetTeam(str8), () => Global.boughtHats.Contains("TWINTAIL"), str8, Teams.GetTeam(str8).description));
            string str9 = "MAJESTY";
            if (Teams.GetTeam(str9) != null)
                _unlocks.Add(new UnlockableHat(false, str9.ToLowerInvariant(), Teams.GetTeam(str9), () => Global.boughtHats.Contains("MAJESTY"), str9, "Max out your level (holy crap!!)"));
            string str10 = "MOONWALK";
            if (Teams.GetTeam(str10) != null)
                _unlocks.Add(new UnlockableHat(false, str10.ToLowerInvariant(), Teams.GetTeam(str10), () => Global.boughtHats.Contains("MOONWALK"), str10, "Raise 8 little men."));
            string str11 = "HIGHFIVES";
            if (Teams.GetTeam(str11) != null)
                _unlocks.Add(new UnlockableHat(false, str11.ToLowerInvariant(), Teams.GetTeam(str11), () => Global.boughtHats.Contains("HIGHFIVES"), str11, Teams.GetTeam(str11).description));
            _unlocks.Add(new UnlockableHat(false, "devtimes", Teams.GetTeam("CAPTAIN"), () => (Profile.CalculateLocalFlippers() & 16U) > 0U, "UR THE BEST", "Thank you for playing Duck Game <3"));
        ...
        public static Unlockable GetUnlock(string identifier) => _unlocks.FirstOrDefault(x => x.id == identifier);

        public static HashSet<Unlockable> GetPendingUnlocks() => _pendingUnlocks;
